...
OPTIONS = {
    ...
    "packages": [
        ...
        "sklearn",
        "scipy",
        # google.genai is a PEP 420 namespace package; imp.find_module()
        # cannot locate it so it must NOT be listed here.  modulegraph traces it
        # automatically via the import in notes_worker.py.
    ],
    "includes": [
        # google.genai (google-genai SDK >=1.0) is a namespace package; include
        # submodules explicitly so modulegraph doesn't miss them.
        "google",
        "google.genai",
        "google.genai.types",
        "google.genai.client",
